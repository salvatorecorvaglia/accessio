...
│   ├── accessio.js         # Core Accessio class
│   ├── core/               # Request dispatching, URL building, errors, retry
│   │   ├── request.js      # Core fetch wrapper
│   │   ├── mergeConfig.js  # Config merging utilities
│   │   ├── buildURL.js     # URL construction and param serialization
│   │   ├── retry.js        # Retry logic with exponential backoff
│   │   └── accessioError.js # Custom error class
│   ├── defaults/           # Default configuration and transforms
│   ├── helpers/            # Utilities
│   │   ├── rateLimiter.js  # Concurrent request rate limiter
│   │   ├── debug.js        # Debug logging helpers
│   │   ├── parseHeaders.js # Header parsing utilities
│   │   ├── settle.js       # Promise resolution logic
│   │   └── transformData.js # Request/response data transforms
...
├── tsup.config.js          # CommonJS build configuration
├── eslint.config.js        # Linting configuration
├── vitest.config.js        # Test configuration (Node.js)
└── vitest.browser.config.js # Test configuration (browser/jsdom)
```
